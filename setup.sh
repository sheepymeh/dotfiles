yay -S --noconfirm --needed acpi alsa-utils android-tools arc-gtk-theme base bash-completion bbswitch code cups-pdf ttf-dejavu dialog dmidecode efibootmgr exfat-utils firefox gnome-keyring grim grub gvfs i3blocks intel-ucode light lightdm linux linux-firmware lollypop lsof mako nano nautilus neofetch networkmanager nextcloud-client npm ntfs-3g p7zip pacman-contrib papirus-icon-theme php-fpm pulseaudio-alsa pulseaudio-bluetooth qbittorrent qt5-wayland slurp sway termite throttled ttf-font-awesome ttf-roboto ttf-roboto-mono unzip wget wl-clipboard xbindkeys xdg-user-dirs xf86-video-intel xf86-video-nouveau xorg-server xorg-server-xwayland xorg-xrandr youtube-dl
